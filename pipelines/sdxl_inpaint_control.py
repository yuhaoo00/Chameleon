...
if is_invisible_watermark_available():
    from diffusers import StableDiffusionXLWatermarker
...
class StyleControlInpaint_sdxl(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def __call__(
        ...
        # 5. Prepare init_image & mask & controlnet_conditioning_image
